...
export class AidonComm extends EventEmitter {
  ...
  /**
   * Close the serial port and stop all timers
   */
  public close(): void {
    if (this.portWatchdog) {
      clearTimeout(this.portWatchdog);
      this.portWatchdog = null;
    }
    if (this.rxTimeout) {
  ...
  /**
   * Watchdog to detect missing data. Not applicable in simulation mode,
   * since there is no real port to reinitialize.
   */
  ...
  private initSimulation(): void {
    ...
    this.simulationInterval = setInterval(() => {
      ...
      // negative curents, correct frame
      const sampleHex = ""
  ...
  private async parseAidon7534(data: Buffer): Promise<void> {
    ...
    try {
      ...
      // };
      const extract = (tagHex: string) => {
        const tag = Buffer.from(tagHex, 'hex');
        const start = data.indexOf(tag) + tag.length + 1; // +1 hyppää '(' yli
        const end   = data.indexOf(Buffer.from(')'), start);
        return parseFloat(data.subarray(start, end).toString());
      };

      const meter: Aidon7534Data = {
        meterDateTime,
        cumulativeActiveEnergyIn: extract('312d303a312e382e30'),
        cumulativeActiveEnergyOut: extract('312d303a322e382e30'),
        cumulativeReactiveEnergyIn: extract('312d303a332e382e30'),
        cumulativeReactiveEnergyOut: extract('312d303a342e382e30',),
        activePowerIn: extract('312d303a312e372e30'),
        activePowerOut: extract('312d303a322e372e30'),
        reactivePowerIn: extract('312d303a332e372e30'),
        reactivePowerOut: extract('312d303a342e372e30'),
        l1activePowerIn: extract('312d303a32312e372e30'),
        l1activePowerOut: extract('312d303a32322e372e30'),
        l2activePowerIn: extract('312d303a34312e372e30'),
        l2activePowerOut: extract('312d303a34322e372e30'),
        l3activePowerIn: extract('312d303a36312e372e30'),
        l3activePowerOut: extract('312d303a36322e372e30'),
        l1reactivePowerIn: extract('312d303a32332e372e30'),
        l1reactivePowerOut: extract('312d303a32342e372e30'),
        l2reactivePowerIn: extract('312d303a34332e372e30'),
        l2reactivePowerOut: extract('312d303a34342e372e30'),
        l3reactivePowerIn: extract('312d303a36332e372e30'),
        l3reactivePowerOut: extract('312d303a36342e372e30'),
        l1RmsVoltage: extract('312d303a33322e372e30'),
        l2RmsVoltage: extract('312d303a35322e372e30'),
        l3RmsVoltage: extract('312d303a37322e372e30'),
        l1RmsCurrent: extract('312d303a33312e372e30'),
        l2RmsCurrent: extract('312d303a35312e372e30'),
        l3RmsCurrent: extract('312d303a37312e372e30')
      };
